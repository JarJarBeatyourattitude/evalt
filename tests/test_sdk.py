...
class DashboardBridgeTests(unittest.TestCase):
    ...
    def test_doctor_repairs_an_old_sdk_and_split_interpreter_with_the_current_hosted_wheel(self):
        ...
        self.assertEqual(payload["hosted_sdk_version"], "0.10.30")
        self.assertEqual(payload["hosted_wheel_url"], "https://evalt.onrender.com/python-sdk/dist/evalt-0.10.30-py3-none-any.whl")
